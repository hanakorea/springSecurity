	...
	<div class="container mt-3">
	   <form method= "" action="">
	     ...
	     <div class="mb-3 mt-3">
	       ...
	       <input type="text" class="form-control" id="username" placeholder="Enter username" name="username" value="${userInfo.username}" readonly>
	     </div>
	     <div class="mb-3">
	     ...
	     <div class="mb-3 mt-3">
	       ...
	       <input type="text" class="form-control" id="creatDate" name="creatDate" value="${userInfo.createDate}" disabled>
	     </div>
